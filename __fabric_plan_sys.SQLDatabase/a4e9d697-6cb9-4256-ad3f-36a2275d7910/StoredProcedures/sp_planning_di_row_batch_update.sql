            ...
            CREATE PROCEDURE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [a4e9d697-6cb9-4256-ad3f-36a2275d7910].data_input_row
                INNER JOIN [a4e9d697-6cb9-4256-ad3f-36a2275d7910].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
