                          ...
                          CREATE PROCEDURE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [a4e9d697-6cb9-4256-ad3f-36a2275d7910].powertable_approval_request_rows
