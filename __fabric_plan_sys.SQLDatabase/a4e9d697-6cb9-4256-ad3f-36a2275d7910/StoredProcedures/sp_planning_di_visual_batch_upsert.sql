        ...
        CREATE   PROCEDURE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [a4e9d697-6cb9-4256-ad3f-36a2275d7910].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [a4e9d697-6cb9-4256-ad3f-36a2275d7910].' + QUOTENAME(@DIVTableName) + ' AS div
