      ...
      CREATE   PROCEDURE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[ib_query_writeback] qw
