CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_approval_request] ([id])
);
