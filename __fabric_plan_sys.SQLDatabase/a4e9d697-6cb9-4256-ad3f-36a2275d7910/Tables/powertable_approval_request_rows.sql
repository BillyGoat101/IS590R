CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_approval_request] ([id])
);
