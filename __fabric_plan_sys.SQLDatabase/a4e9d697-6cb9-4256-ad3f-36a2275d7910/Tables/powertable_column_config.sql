CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_source] ([id])
);
