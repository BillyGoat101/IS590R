CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[ib_query_writeback_destination]([queryId] ASC);
