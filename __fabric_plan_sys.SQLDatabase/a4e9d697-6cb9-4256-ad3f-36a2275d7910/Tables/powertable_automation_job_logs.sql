CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_automation_jobs] ([id])
);
