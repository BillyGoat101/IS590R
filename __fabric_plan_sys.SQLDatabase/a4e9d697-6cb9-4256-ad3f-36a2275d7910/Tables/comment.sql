CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[visual] ([id]) ON DELETE CASCADE
);
