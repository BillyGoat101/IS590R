CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_source] ([id])
);
