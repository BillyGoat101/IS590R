CREATE TABLE [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [a4e9d697-6cb9-4256-ad3f-36a2275d7910].[powertable_source] ([id])
);
